...
class TestGrafo(unittest.TestCase):
    ...
    def test_caminho_euleriano(self):
        self.assertEqual(
            self.g_medio_dfs5.caminho_euleriano(),
            [
                "5",
                "a4",
                "4",
        ...
        self.assertEqual(
            self.g_medio_dfs7.caminho_euleriano(),
            [
                "6",
                "a5",
                "5",
        ...
        self.assertEqual(
            self.com.caminho_euleriano(),
            ["1", "a1", "2", "a3", "4", "a4", "3", "a2", "1"],
        )
        ...
        self.assertEqual(
            self.teste_conexo.caminho_euleriano(),
            [
                "d",
                "a2",
                "a",
        ...
        self.assertEqual(
            self.pares.caminho_euleriano(),
            ["a", "a1", "b", "a3", "c", "a4", "d", "a5", "e", "a6", "f", "a2", "a"],
        )
